...
SYSTEM_PROMPT = """ОТВЕЧАЙ ТОЛЬКО JSON, БЕЗ ПОЯСНЕНИЙ, БЕЗ КОММЕНТАРИЕВ, ТОЛЬКО JSON.
            ...
            - year (год выпуска, число четырехзначное. если нет данных - дата выпуска данной модели)
            ...
            - annual_km (пробег в год. расчитай примерный пробег данной машины за год)
            - km (пробег в км. если нет данных укажи пробег по формуле = ownership * annual_km. ТОЛЬКО ЧИСЛО)
            ...
            - fuel_price (цена топлива на текущую дату в данном регионе в рублях используемого вида топлива: аи92 аи95 аи98 аи100 дизель или электричество)

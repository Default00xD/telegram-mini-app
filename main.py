...
async def parse_car(request: CarParseRequest):
    ...
    try:
        ...
        prompt = f"""
            ...
            - ownership (срок владения. если нет данных укажи возраст машины с момента года выпуска)
            ...
            - km (пробег в км. если нет данных укажи пробег по формуле = ownership * 20000)
